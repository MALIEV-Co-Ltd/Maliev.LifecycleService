...
try
{
    Program.Log.StartingHost(bootstrapLogger, "Lifecycle Service");
    ...
    Program.Log.ServiceStarted(logger, "Lifecycle Service");
    await app.RunAsync();
}
catch (Exception ex)
{
    Program.Log.HostTerminated(bootstrapLogger, ex, "Lifecycle Service");
    throw;
}
finally
{
