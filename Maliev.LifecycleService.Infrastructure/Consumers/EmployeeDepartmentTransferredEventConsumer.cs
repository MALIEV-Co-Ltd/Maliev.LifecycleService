...
/// <summary>
/// Consumer for EmployeeDepartmentTransferredEvent.
/// Triggers onboarding checklist creation if the employee was previously unassigned.
/// </summary>
public class EmployeeDepartmentTransferredEventConsumer : IConsumer<EmployeeDepartmentTransferredEvent>
{
    private readonly IOnboardingRepository _onboardingRepository;
    private readonly ITemplateRepository _templateRepository;
    private readonly IEventPublisher _eventPublisher;
    private readonly ILifecycleMetrics _metrics;
    private readonly ILogger<EmployeeDepartmentTransferredEventConsumer> _logger;

    public EmployeeDepartmentTransferredEventConsumer(
        IOnboardingRepository onboardingRepository,
        ITemplateRepository templateRepository,
        IEventPublisher eventPublisher,
        ILifecycleMetrics metrics,
        ILogger<EmployeeDepartmentTransferredEventConsumer> logger)
    {
